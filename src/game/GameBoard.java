...
public class GameBoard {
	...
	public GameBoard(DiceBox box) {
		...
		field[9] = new Territory("All�gade", 2400, 1000, 1200, 160, 800, 2000, 6000, 9000, 12000);
		//field[10] = new jail
		field[11] = new Territory("Fredriksberg All�", 2800, 2000, 1400, 200, 1000, 3000, 9000, 12500, 15000);
		field[12] = new LaborCamp("Tuborg", 3000, 1500, 80, box);
		field[13] = new Territory("B�lowsvej", 2800, 2000, 1400, 200, 1000, 3000, 9000, 12500, 15000);
		...
		field[24] = new Territory("Gr�nningen", 4800, 3000, 2400, 400, 2000, 6000, 15000, 18500, 22000);
		...
		field[29] = new Territory("�stergade", 5600, 3000, 2800, 480, 2400, 7200, 17000, 20500, 24000);
		...
		field[39] =	new Territory("R�dhuspladsen", 8000, 4000, 4000, 1000, 4000, 12000, 28000, 34000, 40000);
