...
public class GameBoard {
	...
	public GameBoard(DiceBox dice) {
		...
		field[9] = new Territory("All�gade", 2400, 1000);
		//field[10] = new jail
		field[11] = new Territory("Fredriksberg All�", 2800, 2000);
		field[12] = new LaborCamp("Tuborg", 3000, 80, dice);
		field[13] = new Territory("B�lowsvej", 2800, 2000);
		...
		field[23] =	new Territory("�sterbrogade", 4400, 3000);
		field[24] = new Territory("Gr�nningen", 4800, 3000);
		...
		field[29] = new Territory("�stergade", 5600, 3000);
		...
		field[39] =	new Territory("R�dhuspladsen", 8000, 4000);
