...
public class GameBoard {
	...
	public GameBoard(DiceBox box) {
		...
		fieldlist[10] = new Jail("Faengsel");
		...
		fieldlist[23] =	new Territory("Oesterbrogade", 4400, 3000, 2200, 360, 1800, 5000, 14000, 17500, 21000,"Red");
		fieldlist[24] = new Territory("Groenningen", 4800, 3000, 2400, 400, 2000, 6000, 15000, 18500, 22000,"Red");
		...
		fieldlist[37] = new Territory("Frederiksberggade", 7000, 4000, 3500, 700, 3500, 10000, 22000, 26000, 30000, "Magenta");
		fieldlist[38] = new Tax("Indkomstskat", 4000);
		fieldlist[39] =	new Territory("Raadhuspladsen", 8000, 4000, 4000, 1000, 4000, 12000, 28000, 34000, 40000, "Magenta");
