...
public class GameBoard {
	...
	public GameBoard(DiceBox box) {
		...
		field[1] = new Territory("Raadovrevej",1200, 1000, 600, 40, 200, 600, 1800, 3200, 5000,"Blue");
		...
		field[5] = new Fleet("Helsingoer-Helsingborg", 4000, 2000, 500, 1000, 2000, 4000);
		...
		field[9] = new Territory("Allegade", 2400, 1000, 1200, 160, 800, 2000, 6000, 9000, 12000, "Pink");
		field[10] = new Jail("Faengsel");
		field[11] = new Territory("Fredriksberg Alle", 2800, 2000, 1400, 200, 1000, 3000, 9000, 12500, 15000, "Green");
		field[12] = new LaborCamp("Tuborg", 3000, 1500, 80, box);
		field[13] = new Territory("Bulowsvej", 2800, 2000, 1400, 200, 1000, 3000, 9000, 12500, 15000,"Green");
		...
		field[23] =	new Territory("Oesterbrogade", 4400, 3000, 2200, 360, 1800, 5000, 14000, 17500, 21000,"Red");
		field[24] = new Territory("Groenningen", 4800, 3000, 2400, 400, 2000, 6000, 15000, 18500, 22000,"Red");
		...
		field[29] = new Territory("Istergade", 5600, 3000, 2800, 480, 2400, 7200, 17000, 20500, 24000,"White");
		field[30] = new MoveToJail("Gaa I Faengslet");
		...
		field[35] = new Fleet("Raadby-Puttgarden", 4000, 2000, 500, 1000, 2000, 4000);
		...
		field[39] =	new Territory("Raadhuspladsen", 8000, 4000, 4000, 1000, 4000, 12000, 28000, 34000, 40000, "Magenta");
