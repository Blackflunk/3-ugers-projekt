...
public class GameBoard {
	...
	public GameBoard(DiceBox box) {
		...
		fieldlist[1] = new Territory("Rødovrevej",1200, 1000, 600, 40, 200, 600, 1800, 3200, 5000,"Blue");
		...
		fieldlist[5] = new Fleet("Helsingør-Helsingborg", 4000, 2000, 500, 1000, 2000, 4000);
		...
		fieldlist[23] =	new Territory("Østerbrogade", 4400, 3000, 2200, 360, 1800, 5000, 14000, 17500, 21000,"Red");
		fieldlist[24] = new Territory("Grønningen", 4800, 3000, 2400, 400, 2000, 6000, 15000, 18500, 22000,"Red");
		...
		fieldlist[29] = new Territory("Østergade", 5600, 3000, 2800, 480, 2400, 7200, 17000, 20500, 24000,"White");
		fieldlist[30] = new MoveToJail("Gå I Fængslet");
		...
		fieldlist[35] = new Fleet("Rødby-Puttgarden", 4000, 2000, 500, 1000, 2000, 4000);
		...
		fieldlist[39] =	new Territory("Rådhuspladsen", 8000, 4000, 4000, 1000, 4000, 12000, 28000, 34000, 40000, "Magneta");
