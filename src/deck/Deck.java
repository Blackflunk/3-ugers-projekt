...
public class Deck {
	...
	public Deck(Player[] playerlist, GameBoard board){
		...
		cardlist[5] = new MoveToCard("Tag med Mols-Linjen -- Flyt brikken frem og hvis de passerer \"Start\", indkassér da 4000kr", 15, board);
		cardlist[6] = new MoveToCard("Tag ind på Rådhuspladsen", 39, board);
		cardlist[7] = new JailCard("Gå i Fængsel. Ryk direkte til faengsel. Selv om De passerer \"Start\", indkassére de ikke 4000kr", board);
		cardlist[8] = new JailCard("Gåi Fængsel. Ryk direkte til fængsel. Selv om De passerer \"Start\", indkassére de ikke 4000kr", board);
		...
		cardlist[28] = new RecieveIfCard("De modtager \"Matador-legatet for de vaerdige trængende\" stort 40000kr. "
