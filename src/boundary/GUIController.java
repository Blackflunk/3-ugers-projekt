...
public class GUIController {
	...
	public void moveToJail() {
		GUI.showMessage("Du har stoedt på en politiracia, du er blevet arresteret, og bliver forflyttet til fængslet");
	}
	...
	public void showJailTurn() {
		GUI.showMessage("Slaa med terningerne for at proeve at komme ud af f�ngslet");
	}
	...
	public boolean offerMoreHouses(){
		return GUI.getUserLeftButtonPressed("Oensker du at k�be flere huse?", "Ja", "Nej");
	}
	...
	public String offerToSellPlot(){
		return GUI.getUserButtonPressed("Oensker du at s�lge dine grunde?","Ja","Nej");
	}
